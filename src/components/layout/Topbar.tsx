    ...
    <header className="h-16 md:h-20 bg-white/80 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between px-4 md:px-8 border-b border-slate-100">
      <div className="flex items-center gap-3 flex-1">
        ...
        <div className="flex-1 max-w-md hidden sm:block">
          <div className="relative group">
            <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-300 group-focus-within:text-[#0F172A] transition-colors" />
            <Input 
      ...
      <div className="flex items-center gap-3 md:gap-5">
        <Badge variant="outline" className="hidden lg:flex items-center gap-2 border-2 border-primary/20 bg-primary/5 text-primary font-black px-4 h-9 rounded-xl text-[10px] uppercase tracking-widest shadow-sm">
          <Sparkles className="w-3 h-3 text-accent" /> {academicYear}
        </Badge>
        ...
        <div className="flex items-center gap-2.5 md:gap-4 pl-3 md:pl-5 border-l border-slate-100 ml-1">
          ...
          <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-slate-900 flex items-center justify-center text-[10px] font-black text-white shadow-xl ring-2 ring-white/10">
